...
async function scrapeCPAData() {
  ...
  const csvWriter = createObjectCsvWriter({
    // "C:\Users\Herinyhert\Desktop\programacion\proyectos\codigo-postal-argentino"
    path: "C:\Users\Herinyhert\Desktop\programacion\proyectos\codigo-postal-argentino\resultados1.csv",
    header: [
      { id: "provincia", title: "Provincia" },
      { id: "localidad", title: "Localidad" },
      { id: "codigoPostal", title: "Código Postal" },
      ...
      for (const province of provinces) {
        ...
        for (const locality of localities) {
          ...
          for (const street of streets) {
            ...
            // Guardar los resultados en el archivo CSV a medida que se encuentran
            await csvWriter.writeRecords(postalCodesOnStreet);
            console.log(`Datos de la calle (${street.title}) guardados en el archivo CSV`);
